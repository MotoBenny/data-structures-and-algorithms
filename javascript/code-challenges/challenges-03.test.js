...
const typeNum = (arr) => {
  // Solution code here...
  let onlyNums = arr.filter(function(value) {
...
const containsAnd = (arr) => {
  // Solution code here...
  let containsArr = arr.filter(word => word.includes('and'));
  return containsArr;
};
...
For example, notInFirstArray([1,2,3], [1,2,3,4]) returns [4].
  const firstStrings = ['Demi', 'Gregor', 'Hound']; // forbidden values
  const secondStrings = ['Gary', 'Charlotte', 'Demi', 'Gregor', 'Hound']; /arr

------------------------------------------------------------------------------------------------ */

const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let notInArr = arr.filter(value => !forbiddenValues.includes(value));
  return notInArr;
};
